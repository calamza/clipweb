...
<table style="width:100%">
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while($row = mysqli_fetch_assoc($result)) {
          echo "<tr><td>".$row["usuario"]."</td><td>".$row["descripcion"]."</td><td>".$row["link"]. "</td><td>https://mediacms.unomedios.com.ar/view?m=".$row["videoid"]. "</td><td>".$row["inicio"]. "</td><td>".$row["fin"]. "</td></tr>";
        }
      } else {
        echo "0 results";
      }
