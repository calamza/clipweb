...
<table style="width:100%">
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        while($row = mysqli_fetch_assoc($result)) {
          ...
          echo "<tr><td>".$row["descripcion"]."</td><td><a href='".$link_download. "'>Link!</a></td><td><a href='https://mediacms.unomedios.com.ar/view?m=".$row["videoid"]."'>Link!</a></td><td>".$row["inicio"]. "</td><td>".$row["fin"]. "</td></tr>";
        }
      } else {
        echo "0 results";
      }
